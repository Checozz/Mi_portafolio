...
export default function EmailCopy({ copyLabel = "Copiar", copiedLabel = "Copiado!" }) {
  // TODO: Reemplaza este email con el tuyo real
  const email = "sergio.hernandez@ejemplo.com";
